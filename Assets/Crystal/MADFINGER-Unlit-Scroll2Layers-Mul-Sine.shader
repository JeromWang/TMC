...
Properties {
	...
	_SineFreqX ("Base layer sine freq X",Float) = 5 
	_SineFreqY ("Base layer sine freq Y",Float) = 5
...
SubShader {
	...
	v2f vert (appdata_full v)
	{
		...
		o.uv.x += (_Time * _SineFreqX) * _SineAmplX;
		o.uv.y += (_Time * _SineFreqY) * _SineAmplY;
